...
b_outer is forty two with an id of: 6158740 before the block.
c_outer is [42] with an id of: 6158340 before the block.
d_outer is 42 with an id of: 85 before the block.

a_outer id was 85 before the block and is: 85 inside the block.
b_outer id was 6158740 before the block and is: 6158740 inside the block.
c_outer id was 6158340 before the block and is: 6158340 inside the block.
d_outer id was 85 before the block and is: 85 inside the block.

a_outer inside after reassignment is 22 with an id of: 85 before and: 45 after.
b_outer inside after reassignment is thirty three with an id of: 6158740 before and: 6153860 after.
c_outer inside after reassignment is [44] with an id of: 6158340 before and: 6153740 after.
d_outer inside after reassignment is 44 with an id of: 85 before and: 89 after.

a_inner is 22 with an id of: 45 inside the block (compared to 45 for outer).
b_inner is thirty three with an id of: 6153860 inside the block (compared to 6153860 for outer).
c_inner is [44] with an id of: 6153740 inside the block (compared to 6153740 for outer).
...
b_outer is thirty three with an id of: 6158740 BEFORE and: 6153860 AFTER the block.
c_outer is [44] with an id of: 6158340 BEFORE and: 6153740 AFTER the block.
